  ...
  return (
    <>
      ...
      <main id="main-content" className="page-shell legal-page">
        ...
        <section><h2>{copy(locale, { en: "Learning records", ml: "പഠന രേഖകൾ" })}</h2><p>{copy(locale, { en: "A learning cycle records fixed-choice answers, support used, the student's bounded artifact draft and revision, teacher review, and the parent's bounded response. Raw artifact text is visible only to the student and assigned teacher. Kanni does not send it to AI or show it to parents and school administrators.", ml: "പഠനചക്രത്തിൽ നിശ്ചിത ഉത്തരങ്ങൾ, ഉപയോഗിച്ച പിന്തുണ, വിദ്യാർത്ഥിയുടെ പരിമിത സൃഷ്ടി കരടും തിരുത്തലും, അധ്യാപക പരിശോധന, രക്ഷിതാവിന്റെ പരിമിത പ്രതികരണം എന്നിവ രേഖപ്പെടുത്തുന്നു. അസംസ്കൃത സൃഷ്ടി എഴുത്ത് വിദ്യാർത്ഥിക്കും നിയുക്ത അധ്യാപകനും മാത്രം കാണാം. കണ്ണി അത് AI-ലേക്ക് അയക്കുകയോ രക്ഷിതാവിനും സ്കൂൾ അഡ്മിനിസ്ട്രേറ്റർക്കും കാണിക്കുകയോ ചെയ്യുന്നില്ല." })}</p></section>
